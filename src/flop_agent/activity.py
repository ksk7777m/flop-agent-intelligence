...
def append_activity(jsonl_path: Path, markdown_path: Path, room: str, message: Dict[str, Any]) -> None:
    record = {
        "activity_type": message.get("activity_type", "signed_message"),
